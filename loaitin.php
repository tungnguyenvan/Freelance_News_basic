...
$news = $newsController->newsFromLoaiTin($idLoaiTin, $page);
$newsToTal = $newsController->toTal($idLoaiTin);

$theLoaiController = new TheLoaiController();
$theloais = $theLoaiController->index();

$loaiTinController = new LoaiTinController();
$findLoaiTin = $loaiTinController->find($idLoaiTin);

if (isset($_POST['logout'])) {
    session_destroy();
    header("location:loaitins.php?idloaitin=" . $idloaitin);
}
?>
